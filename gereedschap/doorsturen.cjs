...
const blad = [
  ...
  '',
  'DEZE ZES ZIJN VOOR NA DE WINACTIE. Zolang de actie loopt blijft dat bericht',
  'bovenaan staan; elk nieuw bericht duwt hem een plek naar beneden. De automaat',
  'plaatst daarom geen berichten meer, alleen nog verhalen.',
  '',
  'Als het zover is: plaats ze van 1 naar 6, ACHTER ELKAAR, zonder er iets tussen',
  'te zetten. Dan vormen ze vanzelf de bovenste twee rijen van je raster, met',
  'allebei de video\u2019s in het midden:',
  '',
  '    F36 studio     R16 video     F37 prijs        <- de nieuwste rij',
  '    U02 uitspraak  R15 video     U01 uitspraak',
  '',
  'Hoeveel berichten je op dat moment hebt maakt niet uit. De nieuwste drie staan',
  'altijd bovenaan en de drie daarna eronder. Het enige dat telt is dat er niets',
  'tussendoor komt \u2014 ook geen bericht van de bot.',
  '',
